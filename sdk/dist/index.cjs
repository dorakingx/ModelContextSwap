...
async function buildSwapIxWithAnchor(anchor, params, options) {
  ...
  try {
    ...
    try {
      ...
      const ultraFreshProgramId = new import_web3.PublicKey(freshProgramId.toString());
      ...
      if (!ultraFreshProgramId || !(ultraFreshProgramId instanceof import_web3.PublicKey)) {
      ...
      try {
        const finalMetaAddress = new import_web3.PublicKey(idlWithMetadata.metadata.address);
      ...
      if (!(provider.connection instanceof import_web3.Connection)) {
